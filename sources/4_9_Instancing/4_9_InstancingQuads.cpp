...
int main()
{
    ...
    glBindBuffer(GL_ARRAY_BUFFER, instanceVBO);  // this attribute come from a different vertex buffer
    ...
    Shader quadShader("../Shaders/4_9_instancingQuad.vs.glsl", "../Shaders/4_9_instancingQuad.fs.glsl");
