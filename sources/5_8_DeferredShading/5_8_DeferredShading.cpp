...
int main()
{
    ...
    Shader shaderGeometryPass("../Shaders/5_8_gbuffer.vs.glsl", "../Shaders/5_8_gbuffer.fs.glsl");
    Shader shaderLightingPass("../Shaders/5_8_deferred_shading.vs.glsl", "../Shaders/5_8_deferred_shading.fs.glsl");
    Shader shaderLightBox("../Shaders/5_8_deferred_light_box.vs.glsl", "../Shaders/5_8_deferred_light_box.fs.glsl");
