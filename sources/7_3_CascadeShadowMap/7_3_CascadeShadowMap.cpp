...
int main()
{
    ...
    // -------------------------
    Shader shader("../Shaders/7_3_shadow_mapping.vs.glsl", "../Shaders/7_3_shadow_mapping.fs.glsl");
    Shader simpleDepthShader("../Shaders/7_3_shadow_mapping_depth.vs.glsl", "../Shaders/7_3_shadow_mapping_depth.gs.glsl", "../Shaders/7_3_shadow_mapping_depth.fs.glsl");
    Shader debugDepthQuad("../Shaders/7_3_CSM_debug_quad.vs.glsl", "../Shaders/7_3_CSM_debug_quad.fs.glsl");
    Shader debugCascadeShader("../Shaders/7_3_debug_cascade.vs.glsl", "../Shaders/7_3_debug_cascade.fs.glsl");
