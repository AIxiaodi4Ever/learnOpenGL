...
int main()
{
    ...
    Shader shader("../Shaders/4_10_anti_aliasing.vs", "../Shaders/4_10_anti_aliasing.fs");
    Shader screenShader("../Shaders/4_10_aa_post.vs", "../Shaders/4_10_aa_post.fs");
    ...
    // this intermediateFBO is just used for copy multi-sampled color tex data into a normal tex2d
