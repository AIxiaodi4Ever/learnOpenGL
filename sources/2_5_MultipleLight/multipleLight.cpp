...
int main() {
	...
	// ---------------------------------------------------------------
	Shader ourShader("../Shaders/object.vs", "../Shaders/object.fs");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		*/
		...
		ourShader.setVec3("pointLights[0].ambient", pointLightColors[0] * glm::vec3(0.1));
		...
		ourShader.setVec3("pointLights[1].ambient", pointLightColors[1] * glm::vec3(0.1));
		...
		ourShader.setVec3("pointLights[2].ambient", pointLightColors[2] * glm::vec3(0.1));
		ourShader.setVec3("pointLights[2].diffuse", pointLightColors[2]);
		...
		ourShader.setVec3("pointLights[3].ambient", pointLightColors[3] * glm::vec3(0.1));
		ourShader.setVec3("pointLights[3].diffuse", pointLightColors[3]);
