...
int main()
{
    ...
    // -------------------------
    Shader shader("../Shaders/4_6_reflectionCubeMap.vs.glsl", "../Shaders/4_6_reflectionCubeMap.fs.glsl");
  ...
  float skyboxVertices[] = {
    ...
    unsigned int cubeInnerTexture = loadTexture("../resources/textures/awesomeface.png");
