...
int main(int argc, char* argv[])
{
	...
	// -------------------------
	Shader solidShader("../Shaders/7_1_solid.vs.glsl", "../Shaders/7_1_solid.fs.glsl");
	Shader transparentShader("../Shaders/7_1_transparent.vs.glsl", "../Shaders/7_1_transparent.fs.glsl");
	Shader compositeShader("../Shaders/7_1_composite.vs.glsl", "../Shaders/7_1_composite.fs.glsl");
	Shader screenShader("../Shaders/7_1_screen.vs.glsl", "../Shaders/7_1_screen.fs.glsl");
