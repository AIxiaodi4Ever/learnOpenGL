...
int main()
{
    ...
    // -------------------------
    Shader shaderGeometryPass("../Shaders/5_9_ssao_geometry.vs.glsl", "../Shaders/5_9_ssao_geometry.fs.glsl");
    Shader shaderSSAO("../Shaders/5_9_ssao.vs.glsl", "../Shaders/5_9_ssao.fs.glsl");
    Shader shaderSSAOBlur("../Shaders/5_9_ssao.vs.glsl", "../Shaders/5_9_ssao_blur.fs.glsl");
    Shader shaderLightingPass("../Shaders/5_9_ssao.vs.glsl", "../Shaders/5_9_ssao_lighting.fs.glsl");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::mat4 projection = camera.GetPerspective(SCR_WIDTH, SCR_HEIGHT, 0.1f, 50.0f);
