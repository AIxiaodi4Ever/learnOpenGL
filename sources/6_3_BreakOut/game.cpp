...
{
    // load shaders
    ResourceManager::LoadShader("../Shaders/6_3_sprite.vs.glsl", "../Shaders/6_3_sprite.fs.glsl", nullptr, "sprite");
    ResourceManager::LoadShader("../Shaders/6_3_particle.vs.glsl", "../Shaders/6_3_particle.fs.glsl", nullptr, "particle");
    ResourceManager::LoadShader("../Shaders/6_3_post_processing.vs.glsl", "../Shaders/6_3_post_processing.fs.glsl", nullptr, "postprocessing");
    // configure shaders
...
void Game::DoCollisions()
{
    for (GameObject &box : this->Levels[this->Level].Bricks)
    {
        ...
        if (!box.Destroyed)
        {
            ...
            {
                // make shake no matter what collision type is
                ShakeTime = 0.05f;
                Effects->Shake = true;
