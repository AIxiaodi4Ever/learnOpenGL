...
int main()
{
    ...
    Shader shader("../Shaders/5_1_blinnPhong.vs", "../Shaders/5_1_blinnPhong.fs");
    ...
    // load textures
    // -------------
    unsigned int floorTexture = loadTexture("E:/00LearnMaterial/00computerScience/00Graphics/01OpenGL/xffCmake/resources/textures/wood.png");
