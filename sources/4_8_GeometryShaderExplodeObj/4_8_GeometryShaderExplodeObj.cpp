...
int main()
{
    ...
    // --------------------
    Shader shader("../Shaders/4_8_explodeObj.vs.glsl", "../Shaders/4_8_explodeObj.gs.glsl", "../Shaders/4_8_explodeObj.fs.glsl");
    // Shader shader("../Shaders/4_8_testModelLoader.vs.glsl", "../Shaders/4_8_testModelLoader.fs.glsl");
